...
handles.RPfile = fullfile(gitpn,'RPVdsCircuits\Sandbox\KP\vocoded_speech_testing.rcx');


%Load in speaker calibration file
fn = 'rig1012-CeilingD_PureTone_Aug08_2018.cal';
...
searchhname = fullfile(searchpath,'*VocodedSpeechTest.wav');
