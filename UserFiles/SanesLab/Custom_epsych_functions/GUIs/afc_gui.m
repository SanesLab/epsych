function varargout = afc_gui(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @afc_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @afc_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function afc_gui_OpeningFcn(hObject, ~, handles, varargin)
...
function varargout = afc_gui_OutputFcn(hObject, ~, handles) 
