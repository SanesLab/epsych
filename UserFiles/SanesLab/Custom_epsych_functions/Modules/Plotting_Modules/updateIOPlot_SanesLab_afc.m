function handles = updateIOPlot_SanesLab_afc(handles,variables,HITind,GOind,REMINDind)
%handles = updateIOPlot_SanesLab(handles,variables,HITind,GOind,NOGOind,REMINDind)
%
