function RUNTIME = ep_TimerFcn_Start_SanesLab_v2(CONFIG, RUNTIME, AX)
%RUNTIME = ep_TimerFcn_Start_SanesLab_v2(CONFIG, RUNTIME, AX)
%
...
%GUIs (Aversive_detection_GUI.m and Appetitive_detection_GUI.m)
%
%Inputs: 
